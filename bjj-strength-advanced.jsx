        ...
        {tab === "workout" ? (<>
          ...
          <div style={{ padding: "16px 16px 0" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
              <div>
                <div style={{ fontSize: 10, letterSpacing: 3, color: "#444", fontWeight: 600, marginBottom: 2 }}>ADVANCED · BJJ</div>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "20px 16px 10px" }}>
            ...
            <div style={{ fontSize: 12, color: "#555", marginBottom: 16 }}>Advanced · BJJ Functional Strength · F22 + Bowflex 1090</div>
